...
def _prediction_probability(
    *,
    ...
    # Pull uncertain candidates modestly toward neutral rather than overclaiming.
...
def prediction_summary(
    *,
    ...
    Predictions are transparent baseline estimates over the existing risk-adjusted
    canonical opportunity stream. Verified outcome history contributes only when the
    existing calibration layer has enough known binary outcomes. Nothing in this
    module changes thresholds, rules, recommendations, trust or execution authority.
    """
