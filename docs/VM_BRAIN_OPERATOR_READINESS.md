...
Mission Control now exposes the canonical Brain migration/readiness state alongside existing incidents, opportunities, decisions, rule health and entity graph summaries.
